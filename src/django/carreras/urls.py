...
urlpatterns = [
    ...
    path('cursos/<slug:slug>/detalle', views.DetailCourse.as_view(), name='detail-course'),
    path('cursos/<slug:slug>/editar', views.UpdateCourse.as_view(), name='update-course'),
    path('cursos/<slug:slug>/eliminar', views.DeleteCourse.as_view(), name='delete-course'),
