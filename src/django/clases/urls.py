...
urlpatterns = [
    ...
    path(
        "bloques/crear", views.CreateBloqueDeClase.as_view(), name="create-class-block"
    ),
    path(
        "bloques/agregar-bloque-clase",
        views.add_block_class_form,
        name="add-bloque-form",
    ),
    # path('htmx/nuevo-bloque', views.new_form, name='new_form'),
    path(
        "htmx/add-formset/<int:current_total_formsets>",
        views.add_formset,
        name="add-formset",
    ),
    ...
    path(
        ...
        views.UpdateBloqueDeClase.as_view(),
