...
urlpatterns = [
    ...
    # path("<pk>/detail_falta", views.detail_falta, name="detail-falta"),
    path("<pk>/detail_falta", views.DetailFaltaProfesor.as_view(), name="detail-falta"),
    # path("<pk>/eliminar_falta", views.delete_falta, name="delete-falta"),
